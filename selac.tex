...
These \PC based codon models as originally introduced have rarely been used for empirical data \citep[WoolleyEtAl2003, McClellanAndMcCracken2001, BlazejEtAl2017, for exceptions see]  []{CITATIONS}.\marginpar{Cite papers by authors mentioned by reviewer 2 (McClellan, Mackiewicz, Yang, Zhang, Goldstein, Higgs and presumably TamuriEtAl2009) here?}

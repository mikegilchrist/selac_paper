...
%%%%%%%%%%%BEGIN MBE Commands %%%%%%%%%%%%
\documentclass[onecolumn,fleqn,nogrid]{myMBE}%
...
\access{Submitted MBE May 31, accepted Nov 14, Advance Access Nov 27, 2018; doi:10.1101/120238}
%\access{bioRxiv 120238; doi:10.1101/120238}
...
Although often attributed to GY, these later and  simpler models were the first to employ the single term $\omega$ to model the differences in fixation probability between nonsynonymous and synonymyous changes at all sites.

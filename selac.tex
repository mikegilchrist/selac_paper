...
Different enough proteins will fail to function entirely: the active site will not sufficiently match its substrates, a protein will not properly pass through a membrane, and so forth, yet in our model even random sequences still permit survival, just requiring more protein production.

...
%BCO: Methods typically go in supplement / end of doc for Science / Nature. So let's plan on that, figuring this will go there. We'll summarize in the main text
\section*{Methods}

...
\section{Discussion}
One goal of evolutionary biology is to quantify the nature, strength, and, ultimately, shifts in the forces of natural selection relative to genetic drift and mutation.
As data set size and complexity increase, there is a need for more complex and realistic models \citep{GoldmanEtAl1996,ThorneEtAl1996,GoldmanEtAl1998,HalpernAndBruno1998,LartillotAndPhilippe2004} to accomplish this.
...
First, by nesting a model of a sequence's cost-benefit function \Cost/\Func within a broader model allows us to formulate and test more specific biological hypotheses. 

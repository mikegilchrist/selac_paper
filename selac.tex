...
One possible response and the one envisioned here is that the protein is thus produced far more to compensate. 
...
\marginpar{MIKE: Cut unless we provide citations.}
...
\marginpar{MIKE: \DeltaAICc values still missing!}
\end{table}

...
Thus, we feel it is statistically improper to not include these in our counts of the the number of parameters estimated from the data.
In the end, the AIC for majority rule \emph{should} be only as good as or worse than the analysis where we determine the amino acid with maximum likelihood.

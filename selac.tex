...
So GY2008 would not fall into this definition.: JMB: Ok. And I forgot that even though the off-diagonals are technically zero, the diagonals are not expononiated with respect to the big matrix, only individually, so it is multiple matrices, not a single model.}.

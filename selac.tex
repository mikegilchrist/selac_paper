...
J\textsc{UAN JUAN} \surname{C\textsc{HAI}}$^{2,4}$, %Now CROSSKEY ?
...
The gene specific parameter $\psi_g$ is multiplied by additional model terms to make a composite term $\psiprime_g$ which scales the strength and efficacy of selection for the optimal amino acid sequence.
...
Nevertheless, ROC SEMPER correlates strongly the measurements of gene expression experiments (\citet{GilchristEtAl2015}).

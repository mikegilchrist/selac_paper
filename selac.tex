...
Because $A_0$ and $\psi$ always co-occur and are scaled by \Ne, for each gene we estimate a composite term $\psiprime = \psi A_0 b \Ne$ and the optimal amino acid for each position \aoptp of the protein.

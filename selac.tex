...
\end{align*}
The log likelihood is maximized by estimating the combined parameter for C*q*Phi, Ne, two of the three Grantham distance parameters, alpha_c, alpha_p (again, we hold alpha_gamma constant -- see above), the free mutation rate parameters (i.e., five free parameters if assuming GTR) and their three free nucleotide frequency parameters given an alignment and a fixed tree topology.

...
It has been suggested  the gamma distribution in models of nucleotide substitution that by increasing the number of rate categories can often improve accuracy of the estimates (\citet{MayroseEtAl2005}).

...
\selac here follows in this tradition of using multiple substitution matrices, but includes some key advances. 
...
TEXT MIKE WANTS TO INCLUDE:
\selac, Thorne, Halpern, etc are all models of stabilizing selection.
However, how one would alter these models to describe diversifying selection is unclear for all except \selac. 

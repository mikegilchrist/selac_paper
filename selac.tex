...
As part of our model set, we also included a reduced form of each of the two \selac models.
...
Since these models assume that the optimal amino acids are known, it is tempting to assume that the number of parameters in the model are reduced by the number of total sites being analyzed.
However, 

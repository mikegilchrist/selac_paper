...
For each gene, we also estimate its target functionality synthesis rate $\phi$ as well as the sensitivity distribution parameter \alphag, and the optimal amino acid for each position in the protein. 

...
Another example, which we touch upon in the Discussion, is the fact that models that to include codon specific effects, which presumably affect protein assembly costs, and amino acid specific effects, which presumably affect protein functionality, inherently lead to epistatic interactions between sites.

...
Moreover, there is evidence that mutations can influence expression level \citep{brown1997, zanger2013}, though this does not always hold \citep{zanger2013}.
...
One possible mechanism with some theoretical and empirical support which generates a linear relationship between the strength of selection and gene expression is the assumption of compensatory gene expression \citep{KingEtAl2015,LermanEtAl2012,ThieleEtAl2012}.

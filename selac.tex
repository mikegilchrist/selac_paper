...
We use existing substitution models (Jukes Cantor \citet{JukesAndCantor69} or General Time Reversible \citet{Tavare86}) to specify which rates are constrained to be equal for a mutation model.

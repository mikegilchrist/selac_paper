...
Supplemental table ____ compares these. %add table
...
However, as we see in other models (__Goldberg and Rabosky, Hisse__), one can be misled into thinking a parameter matters just because its inclusion improves model fit to a complex reality, but that does not necessarily mean that that particular accurately describes the process. %Add citations
...
This is popular software implementing recent (i.e., ______) models of evolution, including codon models. %CITATIONS

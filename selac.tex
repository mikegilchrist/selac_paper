...
For one, they use only a single substitution matrix and are only applicable for situations in which the substitution process and shifts in the selective environment intrinsically, such as with positive or negative frequency dependent selection. 
...
One advantage of our approach over the work of Thorne et al. is the fact that there are a number of obvious generalizations. 

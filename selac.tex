...
This entire procedure is repeated six times or until the log-likelihood between successive rounds is less than a specified tolerance (the default is XXXX).\footnote{
mikeg: This description is bound to cause a reviewer to ask what the differences were b/w the penultimate and ultimate rounds.

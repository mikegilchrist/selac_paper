...
%  \subfloat[\ ]{\frame{\includegraphics[width=\subfigwidth]{yeast_LGY2004.pdf}}}\footnote{File 'yeast\_LGY2005.pdf' missing from /Figures}
  \caption{Maximum Likelihood Trees for (a) selac, (b) selac with uniform sensitivity $G = 1$, (c) GTR, (d) GY94, and (e) FMutSel0.}
  \label{fig:mleTrees}
\end{figure}
...
%\footnote{are the \selac $\phi$ values rescaled in any way besides setting the substitution rate to 1?}
}\label{fig:selaVsPhi}
    \end{figure}

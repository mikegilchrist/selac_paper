...
\selac also provides quantitative estimates of the probability a given amino acid is optimal for a given site.\marginpar{MIKE: Do we ever present such results?}

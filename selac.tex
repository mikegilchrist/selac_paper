...
Our package requires as input a set of fasta files that contain each coding sequence for a set of taxa, and a topology depicting the hypothesized relationships among them. 

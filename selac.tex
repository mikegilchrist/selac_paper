...
These \PC based codon models as originally introduced have rarely been used for empirical data \citep[for exceptions see][]{WoolleyEtAl2003, McClellanAndMcCracken2001, BlazejEtAl2017}.\marginpar{Cite papers by authors mentioned by reviewer 2 (McClellan, Mackiewicz, Yang, Zhang, Goldstein, Higgs and presumably TamuriEtAl2009) here.}
...
\section{Table}
  ...
  \begin{table}[H]
    ...
    \end{tabular}
    \caption{Comparison of model fits using negative log likelihood ($-ln(\Lik)$), AIC, AICc, and \AICw from analyses of 100 selected genes from 6 yeast taxa \citet{SalichosAndRokas2013}.

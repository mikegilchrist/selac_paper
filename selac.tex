...
Because $A_0$ and $\psi$ always co-occur and are scaled by \Ne, for each gene we estimate a composite term $\psiprime = A_0 \psi \Ne$ and the optimal amino acid for each position \aoptp of the protein.
...
The second stage optimizes the block of gene specific composite parameters $ \psiprime = A_0 \psi \Ne$.

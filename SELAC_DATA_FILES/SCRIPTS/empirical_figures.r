...
pdf("FIGURE_1_SelACwG_vs_Empirical_by_spp_ALLspp.pdf",width = 6, height = 8)
par(mfcol=c(3,2), mar=c(4,4,0.5,0.5), oma=c(1.5,2,1,1))

plot(log(gg$Psi_gamma/gg$functionality_Spar_wG), log(gg$Spar_RNA), axes=FALSE, xlab="", ylab="", ylim=c(1,6), xlim=c(-1.2,0), pch=19, cex=.75, main="")
par(tck=.01)
...
fit <- lm(log(gg$Spar_RNA)~log(gg$Psi_gamma/gg$functionality_Spar_wG))
abline(fit)
actual.max <- 6-1
...
plot(log(gg$Psi_gamma/gg$functionality_Smik_wG), log(gg$Smik_RNA), axes=FALSE, xlab="", ylab="", ylim=c(2,10), xlim=c(-1.2,0), pch=19, cex=.75, main="")
par(tck=.01)
axis(2, at = seq(2,10, by = 2), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
axis(1, at = seq(-1.2,0, by = .2), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
title(ylab=expression(log~phi[RNA-seq]), line=2.5)
title(xlab=expression(log~hat(phi)[SelAC]), line=2)
fit <- lm(log(gg$Smik_RNA)~log(gg$Psi_gamma/gg$functionality_Smik_wG))
abline(fit)
actual.max <- 10-2
...
plot(log(gg$Psi_gamma/gg$functionality_Scer_wG), log(gg$Scer_RNA), axes=FALSE, xlab="", ylab="", ylim=c(-2.4,1.8), xlim=c(-1.2,0), pch=19, cex=.75, main="")
par(tck=.01)
...
plot(log(gg$Psi_gamma/gg$functionality_Scas_wG), log(gg$Scas_Microarray), axes=FALSE, xlab="", ylab="", ylim=c(-3.5,0.5), xlim=c(-1.2,0), pch=19, cex=.75, main="")
par(tck=.01)
axis(2, at = seq(-3.5,0.5, by = 1), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
axis(1, at = seq(-1.2,0, by = .2), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
title(ylab=expression(log~phi[Microarray]), line=2.5)
title(xlab=expression(log~hat(phi)[SelAC]), line=2)
fit <- lm(log(gg$Scas_Microarray)~log(gg$Psi_gamma/gg$functionality_Scas_wG))
abline(fit)
actual.max <- .5--3.5
max.diff <- actual.max-.5
top.text <- (actual.max*.875)-max.diff
...
pdf("FIGURE_S1_SelACwG_vs_ROC_by_spp_ALLspp.pdf",width = 6, height = 8)
par(mfcol=c(3,2), mar=c(4,4,0.5,0.5), oma=c(1.5,2,1,1))
...
pdf("FIGURE_S2_FIGURE_S2_Empirical_vs_ROC_by_spp_ALLspp.pdf",width = 6, height = 8)
par(mfcol=c(3,2), mar=c(4,4,0.5,0.5), oma=c(1.5,2,1,1))
